...
const Chat = () => {
  return (
    < div className=" relative bg-[#36454F4d] m-2  rounded-2xl flex flex-col items-center  h-full max-h-[46vh] select-none
     " >
      ...
      hide-scrollbar
      <div className=" w-full px-4 overflow-y-auto gap-2 flex flex-col " style={{ maxHeight: '400px', overflowY: 'auto', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
