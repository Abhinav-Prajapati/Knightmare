    ...
    <div className="flex flex-col w-full h-max frost-blur p-6 rounded-xl border border-gray-400/30">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col items-center mb-2">
          ...
          <p className="mt-3 text-center text-gray-200">
            Level {level}: <span className="italic text-blue-300">{punchlines[level - 1]}</span>
          </p>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2">
          <button
            className={`flex-1 py-2 px-4 rounded transition-colors ${playAs === PlayerColor.WHITE
              ? "bg-blue-600 text-white"
              : "bg-gray-700 text-gray-200 hover:bg-gray-600"
              }`}
            onClick={() => handleColorSelect(PlayerColor.WHITE)}
          >
            White
          </button>
          <button
            className={`flex-1 py-2 px-4 rounded transition-colors ${playAs === PlayerColor.BLACK
              ? "bg-blue-600 text-white"
              : "bg-gray-700 text-gray-200 hover:bg-gray-600"
              }`}
            onClick={() => handleColorSelect(PlayerColor.BLACK)}
          >
            Black
          </button>
          <button
            className="flex-1 py-2 px-4 rounded bg-gray-700 text-gray-200 hover:bg-gray-600 transition-colors"
